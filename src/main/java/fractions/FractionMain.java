...
public class FractionMain {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("(07.1) negate:");
        System.out.println("ACTUAL:   " + allFractions[4].negate());
        System.out.println("EXPECTED: " + "(-5 / 3)");

        System.out.println("(07.2) negate:");
        System.out.println("ACTUAL:   " + allFractions[5].negate());
        System.out.println("EXPECTED: " + "(-5 / 3)");
        ...
        System.out.println("(33) sumAll:");
        System.out.println("ACTUAL:   " + Fraction.sumAll(fractionsZeroLength));
        System.out.println("EXPECTED: " + "null");
    }
}
